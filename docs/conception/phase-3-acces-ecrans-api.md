...
| Catalogue | `GET /catalogue`, `POST /categories`, `POST /produits`, `POST /produits/import` (CSV), `POST /produits/{id}/disponibilite`, `GET /produits/{id}/historique`, `GET|POST /produits/{id}/recette`, `GET|POST /promotions`, `GET /promotions/prix?zone=`, `POST /postes` |
...
| Caisse | `GET /caisse`, `POST /caisse/ouvrir`, `POST /caisse/{id}/cloturer`, `GET /caisse/{id}/z`, `POST /caisse/encaisser`, `POST /caisse/mouvement`, `POST /caisse/transfert`, `GET /caisse/mouvements`, `POST /paiements/{id}/annuler`, `GET|POST /comptes`, `GET|POST /depenses`, `POST /depenses/{id}/annuler`, `GET|POST /depenses/categories`, `GET /mobile-money?statut=`, `POST /mobile-money/{id}/verifier`, `GET|POST /mobile-money/releves`, `POST /mobile-money/releves/relancer` |
| Stock, achats | `GET /stock`, `POST /stock/articles`, `GET /stock/articles/{id}/mouvements`, `POST /stock/mouvements`, `GET|POST /inventaires`, `GET /inventaires/{id}`, `POST /inventaires/{id}/comptage`, `POST /inventaires/{id}/valider`, `POST /inventaires/{id}/abandonner`, `GET|POST /fournisseurs`, `POST /fournisseurs/reglement`, `GET|POST /achats` (avec `consignes`), `GET|POST /emballages`, `POST /emballages/mouvement`, `POST /emballages/retour`, `POST /emballages/{id}/inventaire`, `GET /emballages/{id}/historique` |
...
| Cloud | poste : `GET /cloud/etat`, `POST /cloud/synchroniser`, `POST /cloud/mot-de-passe`, `GET /cloud/sauvegardes`, `POST /cloud/sauvegardes/{id}/recuperer` ; serveur Internet : `POST /cloud/synchroniser`, `PUT /cloud/sauvegardes/envoi/{nom}`, `GET /cloud/sauvegardes[/{id}]` (clé du restaurant), `POST /proprietaire/connexion`, `GET /proprietaire/tableau` ; page `/proprietaire` |
